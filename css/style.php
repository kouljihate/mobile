...
.ui-header {
    ...
    h1.ui-title {
     ...
     .welcome-padding-left{margin-left:50px!imporant!important;}
    ...
    .notif-secteur-ranked{
    margin:-2% 0 -13% 0!important;
    width:40px;
    height:40px;
    background: url(../images/content/icon-notif-secteur.png) top left no-repeat;
    padding:2px 2px 8px 10px!important;
    font-size:20px!important;
    font-weight:700!important;
    color:#900!important;
    }
    
    .notif-secteur-unranked{
    margin:-2% 0 -13% 0!important;
    width:40px;
    height:40px;
    background: url(../images/content/icon-notif-secteur-unranked.png) top left no-repeat;
    padding:2px 2px 8px 10px!important;
    font-size:20px!important;
    font-weight:700!important;
    color:#900!important;
    ...
    width:30px;
    height:40px;
    background: url(../images/content/icon-bg-radio.png) top left no-repeat;
    padding:5px 2px 8px 3px!important;
    font-size:20px!important;
    font-weight:700!important;
    color:#000!important;
    }
